		...
		foreach($rows as $row )
		{
			...
			$data .='<div class="content container-fluid">
					...
					<div class="option">
						...
						<input type="radio" value="'.$row['Option1'].'" id="option1'.$row['Q_id'].'" class="option1" name="option'.$row['Q_id'].'">
						<label for="option1'.$row['Q_id'].'">'.$row['Option1'].'</label>
						</div>
						<div class="option2class">
						<input type="radio" value="'.$row['Option2'].'" id="option2'.$row['Q_id'].'" class="option2" name="option'.$row['Q_id'].'">
						<label for="option2'.$row['Q_id'].'">'.$row['Option2'].'</label>
						</div>
						<div class="option3class">
						<input type="radio" value="'.$row['Option3'].'" id="option3'.$row['Q_id'].'" class="option3" name="option'.$row['Q_id'].'">
						<label for="option3'.$row['Q_id'].'">'.$row['Option3'].'</label>
						</div>
						<div class="option4class">
						<input type="radio" value="'.$row['Option4'].'" id="option4'.$row['Q_id'].'" class="option4" name="option'.$row['Q_id'].'">
						<label for="option4'.$row['Q_id'].'">'.$row['Option4'].'</label>
						</div>
						<div class="option5class">
						<input type="radio" value="'.$row['Option5'].'" id="option5'.$row['Q_id'].'" class="option5" name="option'.$row['Q_id'].'">
			...
			$number++;
				...
				$data .='<div class="ratecontent container-fluid" style="background-color: white;
					border-radius: 15px;box-shadow: 0 0 2px rgba(0,0,0,.12), 0 2px 4px rgba(0,0,0,.24);">
								...
								<div class="optionrate row">
								 <div class="rate">
								    <input type="radio" id="option5'.$row['Q_id'].'" name="option'.$row['Q_id'].'" value="5" />
								    <label for="option5'.$row['Q_id'].'" title="5">5 stars</label>
								    <input type="radio" id="star4'.$row['Q_id'].'" name="option'.$row['Q_id'].'" value="4" />
								    <label for="option4'.$row['Q_id'].'" title="text">4 stars</label>
								    <input type="radio" id="option3'.$row['Q_id'].'" name="option'.$row['Q_id'].'" value="3" />
								    <label for="option3'.$row['Q_id'].'" title="text">3 stars</label>
								    <input type="radio" id="option2'.$row['Q_id'].'" name="option'.$row['Q_id'].'" value="2" />
								    <label for="option2'.$row['Q_id'].'" title="text">2 stars</label>
								    <input type="radio" id="option1'.$row['Q_id'].'" name="option'.$row['Q_id'].'" value="1" />
				...
				'.$row['Question_desc'].'</div>
					<div class="option">
						<div class="option1class">
						<input type="checkbox" value="'.$row['Option1'].'" id="option1'.$row['Q_id'].'" class="option1" name="option'.$row['Q_id'].'">
						<label for="option1'.$row['Q_id'].'">'.$row['Option1'].'</label><br> 
						</div>
						<div class="option2class">
						<input type="checkbox" value="'.$row['Option2'].'" id="option1'.$row['Q_id'].'" class="option2" name="option'.$row['Q_id'].'">
						<label for="option2'.$row['Q_id'].'">'.$row['Option2'].'</label><br>
						</div>
						<div class="option3class">
						<input type="checkbox" value="'.$row['Option3'].'" id="option1'.$row['Q_id'].'" class="option3" name="option'.$row['Q_id'].'">
						<label for="option3'.$row['Q_id'].'">'.$row['Option3'].'</label><br>
						</div>
						<div class="option4class">
						<input type="checkbox" value="'.$row['Option4'].'" id="option1'.$row['Q_id'].'" class="option4" name="option'.$row['Q_id'].'">
						<label for="option4'.$row['Q_id'].'">'.$row['Option4'].'</label><br>
						</div>
						<div class="option5class">
						<input type="checkbox" value="'.$row['Option5'].'" id="option1'.$row['Q_id'].'" class="option5" name="option'.$row['Q_id'].'">
						<label for="option5'.$row['Q_id'].'">'.$row['Option5'].'</label><br>
						</div>
					</div>
					</div><br>';
